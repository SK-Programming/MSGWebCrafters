          ...
          {editAnimal && (
            ...
            >
              ...
              <TextField
                ...
                fullWidth
                sx={{ mb: 2 }}
                value={editAnimal.shelterContact}
                onChange={(e) => setEditAnimal({ ...editAnimal, shelterContact: e.target.value })}
              />
              <TextField
                label="Description"
                fullWidth
              ...
              <Box
                ...
                sx={{
                  ...
                  mb: 2,
                  cursor: "pointer",
                  bgcolor: isEditActive ? "#f0f0f0" : "transparent",
                }}
              >
                <input {...getEditInputProps()} />
                {isEditActive ? (
                  <Typography>Drop new images here ...</Typography>
                ) : (
                  <Typography>Drag & drop to replace/add images (max 3)</Typography>
                )}
              </Box>
