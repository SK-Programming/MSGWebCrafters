  ...
  >
    <g clip-path="url(#clip0_1292_308)">
      <path
        fill-rule="evenodd"
        clip-rule="evenodd"
        d="M14.4 2.4H16.2C16.6774 2.4 17.1352 2.58964 17.4728 2.92721C17.8104 3.26477 18 3.72261 18 4.2V16.2C18 16.6774 17.8104 17.1352 17.4728 17.4728C17.1352 17.8104 16.6774 18 16.2 18H1.8C1.32261 18 0.864773 17.8104 0.527208 17.4728C0.189642 17.1352 0 16.6774 0 16.2L0 4.2C0 3.72261 0.189642 3.26477 0.527208 2.92721C0.864773 2.58964 1.32261 2.4 1.8 2.4H3.6V0H4.8V2.4H13.2V0H14.4V2.4ZM7.2 9.6H3.6V8.4H7.2V9.6ZM14.4 8.4H10.8V9.6H14.4V8.4ZM7.2 13.2H3.6V12H7.2V13.2ZM10.8 13.2H14.4V12H10.8V13.2Z"
        fill="black"
      />
    </g>
    <defs>
...
const ReviewsIcon = () => (
  ...
  >
    <path
      d="M10 2.5L11.9584 7.3L17.1334 7.68333L13.1667 11.0333L14.4084 16.0667L10 13.3333L5.5917 16.0667L6.83337 11.0333L2.8667 7.68333L8.0417 7.3L10 2.5Z"
      fill="#1C1C26"
    />
    <path
      d="M10 2.5L8.0417 7.3L2.8667 7.68333L6.83337 11.0333L5.5917 16.0667L10 13.3333M10 2.5L11.9584 7.3L17.1334 7.68333L13.1667 11.0333L14.4084 16.0667L10 13.3333"
      stroke="#1C1C26"
...
const Profile = () => (
  ...
  >
    <path
      fill-rule="evenodd"
      clip-rule="evenodd"
      d="M5.66667 4.95833C5.66667 4.20689 5.96518 3.48622 6.49653 2.95486C7.02788 2.42351 7.74855 2.125 8.5 2.125C9.25145 2.125 9.97212 2.42351 10.5035 2.95486C11.0348 3.48622 11.3333 4.20689 11.3333 4.95833C11.3333 5.70978 11.0348 6.43045 10.5035 6.9618C9.97212 7.49316 9.25145 7.79167 8.5 7.79167C7.74855 7.79167 7.02788 7.49316 6.49653 6.9618C5.96518 6.43045 5.66667 5.70978 5.66667 4.95833ZM5.66667 9.20833C4.72736 9.20833 3.82652 9.58147 3.16233 10.2457C2.49814 10.9099 2.125 11.8107 2.125 12.75C2.125 13.3136 2.34888 13.8541 2.7474 14.2526C3.14591 14.6511 3.68641 14.875 4.25 14.875H12.75C13.3136 14.875 13.8541 14.6511 14.2526 14.2526C14.6511 13.8541 14.875 13.3136 14.875 12.75C14.875 11.8107 14.5019 10.9099 13.8377 10.2457C13.1735 9.58147 12.2726 9.20833 11.3333 9.20833H5.66667Z"
      fill="#1C1C26"
    />
  </svg>
);
...
function Navbar({ children }) {
  ...
  if (location.pathname === "/owner" || location.pathname === "/owner/")
    highlightTop = 0;
  else if (location.pathname === "/owner/dashboard") highlightTop = 0;
  else if (location.pathname === "/owner/appointment") highlightTop = 48;
  else if (location.pathname === "/owner/petprofile") highlightTop = 96;
  else if (location.pathname === "/owner/records") highlightTop = 144;
  else if (location.pathname === "/owner/shop") highlightTop = 192;
  else if (location.pathname === "/owner/profile") highlightTop = 240;
  else if (location.pathname === "/owner/messages") highlightTop = 288;
        ...
        >
          <Toolbar sx={{ position: "relative" }}>
            ...
            >
              ...
              >
                <MenuItem onClick={() => navigate("/owner/profile")}>
                  <ListItemIcon>
